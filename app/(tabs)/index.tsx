      ...
      <PagerView style={styles.background} initialPage={0} ref={ref}>
        <View style={styles.background} key="1">
          <View style={styles.page}>
            ...
            />
            <Button title="Get Started ->" onPress={() => {ref.current?.setPage(1)}}></Button>
          </View>
        </View>
        <View style={styles.background} key="2">
          <View style={styles.page}>
            <Button title="<- Page 2 ->" onPress={() => {ref.current?.setPage(2)}}></Button>
          </View>
        </View>
        <View style={styles.background} key="3">
          <View style={styles.page}>
            <Button title="<- Go Back ->" onPress={() => {ref.current?.setPage(0)}}></Button>
          </View>
        </View>
      </PagerView>
    </ImageBackground>
